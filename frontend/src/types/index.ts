...
export interface Product {
  ...
  unit: string;
  min_stock: number;
  price: number;              // POS cost sin IVA — not the displayed price
  costo_pos_con_iva: number | null; // cost con IVA — displayed product price
  precio_publico: number | null;    // customer sale price
  is_active: boolean;
  created_at: string;
...
const FICHA_FIELDS: (keyof Product)[] = [
  ...
  'anio_inicio', 'anio_fin', 'dim_largo', 'dim_ancho', 'dim_alto',
];
